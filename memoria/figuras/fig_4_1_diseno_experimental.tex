\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        \node[conjunto] (scratchcurr) at (6.2,5.4) {\textbf{Conjunto EEG autosupervisado}\\
        ...
        \node[conjunto] (megeegcurr) at (6.2,2.2) {\textbf{Conjunto EEG autosupervisado}\\
        ...
        \node[conjunto] (megmegcurr) at (6.2,-1.0) {\textbf{Conjunto EEG autosupervisado}\\
        ...
        \node[control] (direct) at (6.2,-4.0) {Sin conjunto autosupervisado};
