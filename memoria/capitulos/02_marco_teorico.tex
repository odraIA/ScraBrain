...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        \node[tag] at ($(listen.north west)+(3mm,-3mm)$) {Percepción auditiva};
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        \node[coil, minimum width=3.2mm, minimum height=4.8mm] at (0.7,-3.75) {};
    ...
    \end{tikzpicture}}
    \caption{Esquema conceptual de la observación de una fuente neuronal mediante EEG y MEG. Aunque ambas modalidades reflejan actividad relacionada, difieren en la magnitud física medida, la proyección sobre los sensores y las fuentes de variabilidad.}
