...
Por último, dentro de la percepción del habla existe la opción de utilizar la lectura en lugar de la escucha. En este caso, la actividad cerebral que se registra mientras el participante procesa palabras presentadas de forma aislada o dentro de frases. La lectura natural introduce una dificultad adicional: cada persona fija la mirada sobre las palabras durante intervalos diferentes y puede omitir o volver a leer fragmentos del texto. Por este motivo, algunos conjuntos de datos combinan EEG y seguimiento ocular. El \textit{eye-tracking} permite localizar el inicio y la duración de cada fijación y, a partir de esta información, extraer segmentos de EEG asociados a palabras concretas \cite{hollenstein2020zuco2, panachakel2021covert,alzahrani2024systematic}.
...
\input{figuras/fig_2_9_megxl_overview}
...
\input{figuras/fig_2_10_sota_timeline}
