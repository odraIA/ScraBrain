...
\section{Dataset de fine-tuning: Weissbart et al.}

Una vez realizado el entrenamiento con los cinco conjuntos anteriores, el modelo se ajusta sobre el conjunto de Weissbart et al. \cite{weissbart2020surprisal}. Este conjunto contiene EEG de 13 participantes mientras escuchaban narraciones continuas en inglés. La señal se registró con 64 canales a 1000 Hz y los estímulos se dividieron en 15 fragmentos de historias. En total se dispone de aproximadamente 520 minutos de escucha, equivalentes a unas 8,7 horas de estímulo.
