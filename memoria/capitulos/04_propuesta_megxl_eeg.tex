...
Además, el experimento compara varios tipos de inicializaciones. En una de ellas el modelo parte del modelo que presenta MEG-XL. En otra, la misma arquitectura se inicializa desde cero. Ambas siguen exactamente el mismo orden, lectura seguida de escucha, de modo que la comparación permite estudiar si el preentrenamiento con MEG aporta algún tipo de ventaja al pasar a EEG o si las diferencias entre modalidades impiden aprovecharlo.
...
\input{figuras/fig_4_2_preprocesamiento_eeg}
...
\input{figuras/fig_4_3_arquitectura_eegxl}
...
\input{figuras/fig_4_4_finetuning_palabras}
